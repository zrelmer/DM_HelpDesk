$(document).ready(function(){
	/* ==========================================================================
		...
		// 	// Inicializar jScrollPane solo cuando el documento esté listo
		// 	$(document).ready(function() {
		...
		if (!("ontouchstart" in document.documentElement)) {
			...
			// Event listener para el evento scroll optimizado con throttle
			window.addEventListener('scroll', throttle(() => {
				// console.log('Desplazamiento detectado');
				// Tu lógica de desplazamiento aquí
			}, 100));
		}
	/* ==========================================================================
		Header search
	...
	/* ==========================================================================
		...
		$(window).resize(function(){
			// Esto simula un clic en el cuerpo del documento
			$('body').trigger('click');
		});
		...
		$('.box-typical-dashboard').each(function() {
			...
			btnCollapse.click(function() {
				parent.toggleClass('box-typical-collapsed');
			});
		});
		...
		$('.box-typical-dashboard').each(function() {
			...
			btnExpand.click(function() {
				parent.toggleClass(classExpand);
				$('html').css('overflow', parent.hasClass(classExpand) ? 'hidden' : 'auto');
			});
		});
